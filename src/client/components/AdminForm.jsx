  ...
  render() {
    ...
    return (
      <div>
        ...
        <form>
          <div>
            <label>Enter Game Name ("Edition" will be added to game title e.g "Sports Edition")</label>
            <br/>
            <input className="admin_input" placeholder="Game Name" value={gameName} onChange={updateGameName} />
          </div>
          <br />
          <div>
            <label>Enter Game Icon Name</label>
            <br />
            <input className="admin_input" placeholder="Game Icon" value={gameIcon} onChange={updateIconName} />
          </div>
          <br/>
          <div>
            <label>Enter Background Skin Name</label>
            <br />
            <input className="admin_input" placeholder="Game Icon" value={gameSkin} onChange={updateSkinName} />
          </div>
          <br />
          <div>
            <label>Enter Google Font (primary font)</label>
            <br />
            <input className="admin_input" placeholder="Primary Font" value={primaryFont} onChange={updatePrimaryFont} />
          </div>
          <br />
          <div>
            <label>Enter Google Font (secondary font)</label>
            <br />
            <input className="admin_input" placeholder="Secondary Font" value={secondaryFont} onChange={updateSecondaryFont} />
          </div>
          <br />
          <div> 
            <label>Enter Rules (categories) for Medium Difficulty</label>
            <br />
            <span>*category entered must match category in CSV - click category to remove*</span>
            <br />
            <input className="admin_input" value={newMediumRule} placeholder="Enter Category" onChange={updateNewMediumRule}/>
            <br />
          ...
          <div>
            <label>Enter Rules (categories) for Hard Difficulty</label>
            <br />
            <span>*category entered must match category in CSV - click category to remove*</span>
            <br />
            <input className="admin_input" value={newHardRule} placeholder="Enter Category" onChange={updateNewHardRule} />
            <br />
