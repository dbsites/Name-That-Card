...
const About = (props) => {
  ...
  if (selectedGame === 'MTG') {
    content = (<div className="footerLinks">
      ...
      <p className="p-margins">We welcome your feedback! Please reach out to us at <a className="email" href="mailto:info@namethatcard.com" target="_top">info@namethatcard.com</a></p>
    </div>)
