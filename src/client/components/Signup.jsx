        ...
        <div className="grid">
          ...
          <form className="form login">
            ...
            <div className="form__field">
              ...
              <input id="signup_password" type="password" name="password" className="form__input" placeholder="Password" onChange={updateSignUpPassword} required />
            </div>
            <div className="form__field">
              <span className="hidden">Email</span>
              <input id="signup_email" type="text" name="email" className="form__input" placeholder="Email" onChange={updateSignUpEmail} required />
            </div>
            <div className="form__field">
